      ...
      class << self
        ...
        def configure(app)
          ...
          asset_configuration.process do |page, config|
            ...
            #TODO: make sure the dirs are clean
            # page.assetize
          end
...
TEXT
        ...
        def maybe_init_r18n(settings)
          return unless settings.r18n

          require 'r18n-desktop'
          include R18n::Helpers
          R18n.from_env settings.r18n_default
          @r18n =  R18n::I18n.new([settings.r18n_default || 'en'], 'translations/')
        end
